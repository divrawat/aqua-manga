...
// export const DOMAIN = 'https://coffee-manga.online';
export const BACKEND_DOMAIN = 'https://backend-mangawebsite.vercel.app'



export const DOMAIN_NAME = 'coffee-manga.online';
export const IMAGES_SUBDOMAIN = "https://photos.coffee-manga.online";
export const DISQUS_SHORTNAME = "my-cms-7";


export const APP_NAME = 'Coffee Manga';
export const NavbarName = "Coffee Manga";
